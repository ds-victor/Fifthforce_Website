    ...
    <main>
      ...
      <section className="container" style={{ minHeight: '80vh', paddingTop: '10rem' }}>
        ...
        <div style={{ color: 'var(--color-gray-light)' }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>1. Information We Collect</h2>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>2. How We Use Your Information</h2>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>3. Data Security</h2>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>4. Contact Us</h2>
