    ...
    <main>
      ...
      <section className="container" style={{ minHeight: '80vh', paddingTop: '10rem' }}>
        ...
        <div style={{ color: 'var(--color-gray-dark)' }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-black)' }}>1. Use License</h2>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-black)' }}>2. Disclaimer</h2>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-black)' }}>3. Limitations</h2>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-black)' }}>4. Modifications</h2>
